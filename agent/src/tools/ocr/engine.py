...
def _reset_plugin_cache() -> None:
    ...
    # Tests may have monkeypatched _discover_plugins with a bare function;
    # a teardown that runs before the patch is undone must not blow up.
    cache_clear = getattr(_discover_plugins, "cache_clear", None)
