...
from src.api.deploy_routes import (  # noqa: E402
    start_deploy_scheduler as _start_deploy_scheduler,
    stop_deploy_scheduler as _stop_deploy_scheduler,
)
...
# --- Deterministic deployment runtime (src/deploy, fork feature) ---
from src.api.deploy_routes import register_deploy_routes  # noqa: E402
register_deploy_routes(app, require_auth, require_event_stream_auth)
